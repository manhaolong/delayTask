...
@Configuration
@MapperScan(basePackages = {"com.ismarthealth.delaytask.server.mapper.**"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public TransactionInterceptor transactionInterceptor(PlatformTransactionManager transactionManager) {
        ...
        transactionAttributes.setProperty("is*", PROPAGATION_REQUIRED + ",readOnly");
